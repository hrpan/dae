...
def get_args():
    ...
    parser.add_argument('--algo', type=str, default='PPO', help='Which algorithm to use')
    parser.add_argument('--envs', type=str, default=[], nargs='+', help='Environments to train')
    parser.add_argument('--steps', type=int, default=10000000, help='Number of agent steps to train')
    parser.add_argument('--save_model', default=False, action='store_true', help='Save the trained model')
    parser.add_argument('--logging', default=False, action='store_true', help='Logging')
    parser.add_argument('--seed', type=int, default=0, help='Seed')
    parser.add_argument('--hparam_file', type=str, required=True, help='YAML file for hyperparameters')
    parser.add_argument('--run_id', type=int, default=0, help='run ID, used for logging')
    parser.add_argument('--threads', type=int, default=1, help='Number of threads for asynchronous environment steps')
...
if __name__ == '__main__':
    ...
    for _env in args.envs:
        ...
        algo = algo_cls(policy, env, verbose=1, tensorboard_log=logdir, seed=args.seed, **hparam)
